          ...
          <Card>
            ...
            <CardContent className="flex flex-col items-center pt-4 space-y-4">
              ...
              <div className="text-center">
                ...
                <p className="text-xs font-mono text-muted-foreground mt-1 break-all px-4">{user.wallet}</p>
            ...
            <CardContent className="pt-0">
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm truncate">Wallet: {`${user.wallet.slice(0, 6)}...${user.wallet.slice(-4)}`}</span>
                </div>
              </div>
